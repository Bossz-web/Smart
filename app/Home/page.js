...
export default function Home() {
  return (
    <>
{/* Top */}
<main className="min-h-screen gap-8 mx-auto w-full flex bg-white font-sans">
  <div className="font-sans gap-8 flex mx-auto w-max md:flex-row flex-col justify-center items-center md:mx-44">
     {/* First Contents in the Left Div*/}
       <section className="lg:w-1/2 w-max h-full p-5 mx-auto">
         <h1 className="text-[25px] pb-8 text-gray-600 font-medium text-center sm:text-left"> Welcome back, <span className="font-medium text-gray-900">Alvan!</span></h1>
       ...
       <h1 className="text-3xl pb-5 font-"> $1,250.80</h1>
      <div className="flex mt-4 items-center space-x-4">
        <button className="rounded-xl border flex items-center gap-3 px-8 py-3 hover:bg-gray-800 hover:text-white transition-all duration-1000"> <BsArrowDownRightSquare /><a href="/top-up">Top up</a></button>
        ...
        <button className="rounded-xl border flex items-center gap-3 px-8 py-3 hover:bg-gray-800 hover:text-white transition-all duration-1000"><CgArrowsExchangeAlt className="text-xl" /> <a href="/convert">Convert</a></button>
      </div>
{/* Transaction history */}
...
{/* Date picker */}
    <div className="">
      <button className="flex items-center gap-2 hover:bg-gray-800 hover:text-white transition-all duration-1000  px-3 py-2 w-max border rounded-lg">05 <IoIosArrowDown /></button>
    </div>
      <div className="">
          <input type="date" className="uppercase px-3 py-2 border rounded-lg cursor-pointer"/>
      </div>
        <div className="">
            <button className=" hover:bg-gray-800 flex items-center gap-3 hover:text-white transition-all duration-1000  px-3 py-2 w-max border rounded-lg"><CgArrowDownR />Export as<IoIosArrowDown /></button>
              </div>
                </div>
        </section>
 ...
 <div className="pb-24 justify-center flex">
  ...
  {/* Second Contents */}
  <section className="h-full mx-auto w-max p-5">
    ...
    <div className="lg:w-1/2 w-full h-full text-left">
        ...
        <div className="flex space-x-10 py-3">
          <div className="">
            ...
            <h1 className="text-2xl">04/28</h1>
          </div>
